...
function SignUpPage({ onSignUp, onBack, onNavigateToLogin }) {
  ...
  const handleGoogleSignUp = () => {
    ...
    alert('Google sign-up would be implemented here with OAuth 2.0');
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-8">
        ...
        <h2 className="text-2xl font-bold mb-2">Create a free account for</h2>
        <h3 className="text-2xl font-bold mb-6">unlimited access</h3>
